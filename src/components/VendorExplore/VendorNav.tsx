...
import { MdDashboard, MdOutlineStickyNote2, MdAccountCircle } from "react-icons/md";
...
function VendorNav() {
    return ( 
        <Stack bg='white' p='30px' px='40px' spacing={6} h='100%' w='max-content'>
            <Text fontSize='30px' fontWeight='40px' color="blue" py='30px'>Venduit</Text>
            ...
            <Button colorScheme='blue' width='fit-content'>Cyrpto p2p</Button>

            <Flex gap='1rem' mt='150px'>
            <FaSignOutAlt />
